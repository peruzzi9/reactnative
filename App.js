 ...
 let [displayResponsive, setdisplayResponsive] = useState(false) ;
  return (
    ...
    <View style={styles.container}>
          ...
          <Button onPress={()=>setdisplayResponsive(!displayResponsive)} title="Display Responsive" color="#555fff"  accessibilityLabel="Tap on Me"/>
    ...
    <View style={styles.topMenu}> 
        <View style={styles.menuItem}><Text style={styles.textHeader}>home</Text></View>
        <View style={styles.menuItem}><Text style={styles.textHeader}>services</Text></View>
        <View style={styles.menuItem}><Text style={styles.textHeader}>contactus</Text></View>
    </View>
    </View>
